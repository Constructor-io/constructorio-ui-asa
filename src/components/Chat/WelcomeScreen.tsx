  ...
  return (
    <div className='cio-asa-welcome-screen'>
      <div className='cio-asa-welcome-screen__content'>
        ...
        <div className={`cio-asa-welcome-screen__input-row${disabled ? ' cio-asa-welcome-screen__input-row--disabled' : ''}`}>
          <input
            type='text'
